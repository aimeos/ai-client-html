...
<div>
			...
			<div class="row g-0 product-item <?= ( isset( $errors['product'][$position] ) ? 'error' : '' ) ?>">
				<div class="col-4 col-md-6">
					<div class="row g-0">
						...
						<div class="col-11 col-lg-3 image">
				...
				<div class="col-8 col-md-6">
					<div class="row g-0 order">
						...
						<div class="col-3 unitprice"><?= $enc->html( sprintf( $priceFormat, $this->number( $product->getPrice()->getValue(), $precision ), $priceCurrency ) ) ?></div>
						<div class="col-3 price"><?= $enc->html( sprintf( $priceFormat, $this->number( $product->getPrice()->getValue() * $product->getQuantity(), $precision ), $priceCurrency ) ) ?></div>
						<?php if( $modify ) : ?>
			...
			<div class="row g-0 delivery">
				<div class="col-7 col-md-6">
					<div class="row g-0">
						...
						<div class="col-12 col-lg-8 details"><?= $enc->html( $service->getName() ) ?></div>
					</div>
				</div>
				<div class="col-5 col-md-6">
					<div class="row g-0">
						<div class="col-5 quantity">1</div>
						<div class="col-3 unitprice"><?= $price ?></div>
	...
	<?php if( $priceTaxflag === false || $this->summaryBasket->getPrice()->getCosts() > 0 ) : ?>
		<div class="row g-0 subtotal">
			<div class="col-8 col-md-6 offset-4 offset-md-6">
				<div class="row g-0">
					<div class="col-8"><?= $enc->html( $this->translate( 'client', 'Sub-total' ) ) ?></div>
					<div class="col-3 price"><?= $enc->html( sprintf( $priceFormat, $this->number( $this->summaryBasket->getPrice()->getValue(), $precision ), $priceCurrency ) ) ?></div>
					<?php if( $modify ) : ?>
						<div class="col-1 action"></div>
					<?php endif ?>
				</div>
		...
		<div class="row g-0 delivery">
			<div class="col-8 col-md-6 offset-4 offset-md-6">
				<div class="row g-0">
					...
					<div class="col-3 price"><?= $enc->html( sprintf( $priceFormat, $this->number( $costs, $precision ), $priceCurrency ) ) ?></div>
					<?php if( $modify ) : ?>
					<div class="col-1 action"></div>
					<?php endif ?>
				</div>
		...
		<div class="row g-0 total">
			<div class="col-8 col-md-6 offset-4 offset-md-6">
				<div class="row g-0 price-total">
					<div class="col-5 quantity"><?= $enc->html( sprintf( $this->translate( 'client', '%1$s article', '%1$s articles', ceil( $totalQuantity ) ), round( $totalQuantity, 3 ) ) ) ?></div>
					<div class="col-3 total-text"><?= $enc->html( $this->translate( 'client', 'Total' ) ) ?></div>
					<div class="col-3 price"><?= $enc->html( sprintf( $priceFormat, $this->number( $this->summaryBasket->getPrice()->getValue() + $this->summaryBasket->getPrice()->getCosts(), $precision ), $priceCurrency ) ) ?></div>
					<?php if( $modify ) : ?>
						<div class="col-1 action"></div>
					<?php endif ?>
				</div>
				...
				<div class="row g-0 tax">
					<div class="col-8 col-md-6 offset-4 offset-md-6">
						<div class="row g-0">
							...
							<div class="col-3 price"><?= $enc->html( sprintf( $priceFormat, $this->number( $taxValue, $precision ), $priceCurrency ) ) ?></div>
							<?php if( $modify ) : ?>
								<div class="col-1 action"></div>
							<?php endif ?>
						</div>
	...
	<?php if( $priceTaxflag === false ) : ?>
		<div class="row g-0 total">
			<div class="col-8 col-md-6 offset-4 offset-md-6">
				<div class="row g-0">
					<div class="col-5 quantity"><?= $enc->html( sprintf( $this->translate( 'client', '%1$d article', '%1$d articles', $totalQuantity ), $totalQuantity ) ) ?></div>
					<div class="col-3 unitprice"><?= $enc->html( $this->translate( 'client', 'Total' ) ) ?></div>
					<div class="col-3 price"><?= $enc->html( sprintf( $priceFormat, $this->number( $this->summaryBasket->getPrice()->getValue() + $this->summaryBasket->getPrice()->getCosts() + $this->summaryBasket->getPrice()->getTaxValue(), $precision ), $priceCurrency ) ) ?></div>
					<?php if( $modify ) : ?>
						<div class="col-1 action"></div>
					<?php endif ?>
				</div>
	...
	<?php if( $this->summaryBasket->getPrice()->getRebate() > 0 ) : ?>
		<div class="row g-0 rebate">
			<div class="col-8 col-md-6 offset-4 offset-md-6">
				<div class="row g-0">
					<div class="col-8 quantity"><?= $enc->html( $this->translate( 'client', 'Included rebates' ) ) ?></div>
					<div class="col-3 price"><?= $enc->html( sprintf( $priceFormat, $this->number( $this->summaryBasket->getPrice()->getRebate(), $precision ), $priceCurrency ) ) ?></div>
					<?php if( $modify ) : ?>
						<div class="col-1 action"></div>
					<?php endif ?>
				</div>
