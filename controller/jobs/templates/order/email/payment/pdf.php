...
$this->pdf->setTitle( sprintf( $this->translate( 'client', 'Order %1$s' ), $this->orderItem->getOrderNumber() ) );
		...
		<td style="width: 33%">
			<table class="meta">
				<tr>
					...
					<td><?= $enc->html( date_create( $this->orderItem->getTimeCreated() )->format( $this->translate( 'client', 'Y-m-d' ) ) ) ?></td>
				</tr>
...
<h2><?= $enc->html( $this->translate( 'client', 'Order' ) ) ?>: <?= $enc->html( $this->orderItem->getOrderNumber() ) ?></h2>
<?= $this->partial(
