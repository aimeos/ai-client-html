...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp() : void
	{
		...
		$this->object = new \Aimeos\Client\Html\Catalog\Supplier\Standard( $this->context );
	...
	public function testBody()
	{
		...
		$this->assertStringContainsString( '<div class="section catalog-filter-supplier', $output );
	}
