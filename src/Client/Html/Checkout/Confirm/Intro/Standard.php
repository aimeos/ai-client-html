...
/**
 * Default implementation of checkout intro HTML client.
 *
 * @package Client
 * @subpackage Html
 */
...
{
	/** client/html/checkout/confirm/intro/subparts
	 ...
	 * @since 2014.03
	 */
	private $subPartPath = 'client/html/checkout/confirm/intro/subparts';
	...
	public function body( string $uid = '' ) : string
	{
		...
		/** client/html/checkout/confirm/intro/template-body
		 ...
		 * @see client/html/checkout/confirm/intro/template-header
		 */
		$tplconf = 'client/html/checkout/confirm/intro/template-body';

		$status = $view->confirmOrderItem->getStatusPayment();
		$default = array( 'checkout/confirm/' . $status . '/intro-body', 'checkout/confirm/intro-body' );
