...
/**
 * Factory for product download HTML client in user accounts.
 *
 * @package Client
 * @subpackage Html
 */
	...
	implements \Aimeos\Client\Html\Common\Factory\Iface
{
	 ...
	 * @return \Aimeos\Client\Html\Iface Download part implementing \Aimeos\Client\Html\Iface
	...
	public static function create( \Aimeos\MShop\ContextIface $context, string $name = null ) : \Aimeos\Client\Html\Iface
	{
		 ...
		 */
		if( $name === null ) {
			$name = $context->config()->get( 'client/html/account/download/name', 'Standard' );
		}
