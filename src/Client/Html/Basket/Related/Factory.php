	...
	implements \Aimeos\Client\Html\Common\Factory\Iface
{
	 ...
	 * @return \Aimeos\Client\Html\Iface Related part implementing \Aimeos\Client\Html\Iface
	...
	public static function create( \Aimeos\MShop\ContextIface $context, string $name = null ) : \Aimeos\Client\Html\Iface
	{
		 ...
		 */
		if( $name === null ) {
			$name = $context->config()->get( 'client/html/basket/related/name', 'Standard' );
		}
		...
		$client = self::addClientDecorators( $context, $client, 'basket/related' );
