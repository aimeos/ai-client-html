...
/**
 * Factory for mini basket for HTML clients.
 *
 * @package Client
 * @subpackage Html
 */
	...
	implements \Aimeos\Client\Html\Common\Factory\Iface
{
	 ...
	 * @return \Aimeos\Client\Html\Iface Mini part implementing \Aimeos\Client\Html\Iface
	...
	public static function create( \Aimeos\MShop\ContextIface $context, string $name = null ) : \Aimeos\Client\Html\Iface
	{
		 ...
		 */
		if( $name === null ) {
			$name = $context->config()->get( 'client/html/basket/mini/name', 'Standard' );
		}
		...
		$client = self::addClientDecorators( $context, $client, 'basket/mini' );
