...
/**
 * Factory for stock part in catalog for HTML clients.
 *
 * @package Client
 * @subpackage Html
 */
	...
	implements \Aimeos\Client\Html\Common\Factory\Iface
{
	 ...
	 * @return \Aimeos\Client\Html\Iface Stock part implementing \Aimeos\Client\Html\Iface
	...
	public static function create( \Aimeos\MShop\ContextIface $context, string $name = null ) : \Aimeos\Client\Html\Iface
	{
		 ...
		 */
		if( $name === null ) {
			$name = $context->config()->get( 'client/html/catalog/stock/name', 'Standard' );
		}
		...
		$client = self::addClientDecorators( $context, $client, 'catalog/stock' );
