...
namespace Aimeos\Client\Html\Catalog\Detail\Image;
...
class StandardTest extends \PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new \Aimeos\Client\Html\Catalog\Detail\Image\Standard( \TestHelperHtml::getContext(), $paths );
	...
	public function testGetBody()
	{
		...
		$this->assertStringStartsWith( '<div class="catalog-detail-image', $output );
	}
