...
namespace Aimeos\Client\Html\Catalog\Detail\Additional\Download;
...
class StandardTest extends \PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new \Aimeos\Client\Html\Catalog\Detail\Additional\Download\Standard( \TestHelperHtml::getContext(), $paths );
	...
	protected function getProductItem()
	{
		...
		$items = $manager->searchItems( $search, array( 'media' ) );
