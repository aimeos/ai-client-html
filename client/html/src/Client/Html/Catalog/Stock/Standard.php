...
{
	/** client/html/catalog/stock/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/catalog/stock/subparts';
	...
	public function body( string $uid = '' ) : string
	{
		...
		try
		{
			 ...
			 */
			$tplconf = 'client/html/catalog/stock/template-body';
	...
	public function header( string $uid = '' ) : ?string
	{
		...
		try
		{
			 ...
			 */
			$tplconf = 'client/html/catalog/stock/template-header';
