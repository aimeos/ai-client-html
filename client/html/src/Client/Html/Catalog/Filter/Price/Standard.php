...
{
	/** client/html/catalog/filter/price/standard/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/catalog/filter/price/standard/subparts';
	...
	public function getBody( string $uid = '' ) : string
	{
		...
		/** client/html/catalog/filter/price/standard/template-body
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/catalog/filter/price/standard/template-header
		 */
		$tplconf = 'client/html/catalog/filter/price/standard/template-body';
