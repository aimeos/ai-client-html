...
{
	/** client/html/catalog/filter/search/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/catalog/filter/search/subparts';
	...
	public function body( string $uid = '' ) : string
	{
		 ...
		 */
		$tplconf = 'client/html/catalog/filter/search/template-body';
