...
{
	/** client/html/catalog/filter/supplier/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/catalog/filter/supplier/subparts';
	...
	public function body( string $uid = '' ) : string
	{
		 ...
		 */
		$tplconf = 'client/html/catalog/filter/supplier/template-body';
