...
{
	/** client/html/catalog/filter/supplier/standard/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/catalog/filter/supplier/standard/subparts';
	...
	public function getBody( $uid = '' )
	{
		...
		/** client/html/catalog/filter/supplier/standard/template-body
		 ...
		 * @since 2018.07
		 * @category Developer
		 * @see client/html/catalog/filter/supplier/standard/template-header
		 */
		$tplconf = 'client/html/catalog/filter/supplier/standard/template-body';
		$default = 'catalog/filter/supplier-body-standard.php';
	...
	public function getSubClient( $type, $name = null )
	{
		 ...
		 * @see client/html/catalog/filter/supplier/decorators/global
		 * @see client/html/catalog/filter/supplier/decorators/local
		 */
		 ...
		 * @category Developer
		 * @see client/html/common/decorators/default
		 * @see client/html/catalog/filter/supplier/decorators/excludes
		 * @see client/html/catalog/filter/supplier/decorators/local
		 */
		...
		return $this->createSubClient( 'catalog/filter/supplier/' . $type, $name );
	}
	...
	{
		$cntl = \Aimeos\Controller\Frontend\Factory::createController( $this->getContext(), 'supplier' );
