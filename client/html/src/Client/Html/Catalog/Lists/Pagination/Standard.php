	...
	implements \Aimeos\Client\Html\Common\Client\Factory\Iface
{
	...
	public function getBody( $uid = '', array &$tags = array(), &$expire = null )
	{
		 ...
		 * example, use the key
		 *
		 * client/html/catalog/lists/pagination/standard/template-body-list = catalog/lists/pagination-body-list.php
		 *
	...
	public function getHeader( $uid = '', array &$tags = array(), &$expire = null )
	{
		 ...
		 * example, use the key
		 *
		 * client/html/catalog/lists/pagination/standard/template-header-list = catalog/lists/pagination-header-list.php
		 *
		 * The argument is the relative path to the new template file. The type of
		 * the view is determined by the "l_type" parameter (allowed characters for
		 * the types are a-z and 0-9), which is also stored in the session so users
