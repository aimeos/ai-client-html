...
{
	/** client/html/catalog/count/supplier/standard/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/catalog/count/supplier/standard/subparts';
	...
	public function getBody( $uid = '', array &$tags = [], &$expire = null )
	{
		...
		/** client/html/catalog/count/supplier/standard/template-body
	...
	public function addData( \Aimeos\MW\View\Iface $view, array &$tags = [], &$expire = null )
	{
		...
		if( $config->get( 'client/html/catalog/count/supplier/aggregate', true ) == true )
		{
			 ...
			 * that are available for each supplier or category.
			 *
			 ...
			 * an supplier or in a category despite the fact that there would be at least
			 * one.
			 *
			 * @param integer Number of records
			 * @since 2018.07
			 * @see client/html/catalog/count/supplier/aggregate
			 * @category Developer
			 * @category User
			 */
