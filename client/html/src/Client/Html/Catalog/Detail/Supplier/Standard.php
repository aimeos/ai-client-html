...
/**
 * Default implementation of catalog detail supplier section for HTML clients.
 *
 * @package Client
 * @subpackage Html
 */
...
{
	/** client/html/catalog/detail/supplier/standard/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/catalog/detail/supplier/standard/subparts';
	...
	public function getBody( string $uid = '' ) : string
	{
		...
		/** client/html/catalog/detail/supplier/standard/template-body
		 ...
		 * @since 2019.10
		 * @category Developer
		 * @see client/html/catalog/detail/supplier/standard/template-header
		 */
		$tplconf = 'client/html/catalog/detail/supplier/standard/template-body';
	...
	public function getSubClient( string $type, string $name = null ) : \Aimeos\Client\Html\Iface
	{
		 ...
		 * @see client/html/catalog/detail/supplier/decorators/global
		 * @see client/html/catalog/detail/supplier/decorators/local
		 */
		 ...
		 * @category Developer
		 * @see client/html/common/decorators/default
		 * @see client/html/catalog/detail/supplier/decorators/excludes
		 * @see client/html/catalog/detail/supplier/decorators/local
		 */
		 ...
		 * @see client/html/common/decorators/default
		 * @see client/html/catalog/detail/supplier/decorators/excludes
		 * @see client/html/catalog/detail/supplier/supplier/decorators/global
		 */

		return $this->createSubClient( 'catalog/detail/supplier/' . $type, $name );
	}
	...
	public function addData( \Aimeos\MW\View\Iface $view, array &$tags = [], string &$expire = null ) : \Aimeos\MW\View\Iface
	{
		...
		/** client/html/catalog/detail/supplier/domains
		 ...
		 * @category Developer
		 */
		$domains = $config->get( 'client/html/catalog/detail/supplier/domains', ['text', 'media', 'supplier/address'] );

		$view->supplierItems = \Aimeos\Controller\Frontend::create( $context, 'supplier' )->uses( $domains )
			->has( 'product', 'default', $view->detailProductItem->getId() )->search();

		$this->addMetaItems( $view->supplierItems, $expire, $tags );
