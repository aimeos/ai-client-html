...
{
	/** client/html/catalog/detail/supplier/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/catalog/detail/supplier/subparts';
	...
	public function getBody( string $uid = '' ) : string
	{
		...
		/** client/html/catalog/detail/supplier/template-body
		 ...
		 * @since 2019.10
		 * @category Developer
		 * @see client/html/catalog/detail/supplier/template-header
		 */
		$tplconf = 'client/html/catalog/detail/supplier/template-body';
