...
{
	/** client/html/catalog/detail/seen/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/catalog/detail/seen/subparts';
	...
	protected function getHtml( string $name, string $prodId = null ) : string
	{
		...
		if( ( $html = $cache->get( $key ) ) === null )
		{
			...
			/** client/html/catalog/detail/seen/template-body
			 ...
			 * @since 2014.03
			 * @category Developer
			 * @see client/html/catalog/detail/seen/template-header
			 */
			$tplconf = 'client/html/catalog/detail/seen/template-body';
			$default = 'catalog/detail/seen-partial';
