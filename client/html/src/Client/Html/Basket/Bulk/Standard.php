...
{
	/** client/html/basket/bulk/standard/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/basket/bulk/standard/subparts';
	...
	public function getBody( string $uid = '' ) : string
	{
		...
		if( ( $html = $this->getBasketCached( $key ) ) === null )
		{
			 ...
			 * @since 2019.10
			 * @category Developer
			 * @see client/html/basket/bulk/standard/template-header
			 */
			$tplconf = 'client/html/basket/bulk/standard/template-body';
	...
	public function getHeader( string $uid = '' ) : ?string
	{
		...
		if( ( $html = $this->getBasketCached( $key ) ) === null )
		{
			try
			{
				 ...
				 * @since 2019.10
				 * @category Developer
				 * @see client/html/basket/bulk/standard/template-body
				 */
				$tplconf = 'client/html/basket/bulk/standard/template-header';
