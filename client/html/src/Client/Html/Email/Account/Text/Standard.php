...
{
	/** client/html/email/account/text/standard/subparts
	...
	public function getBody( $uid = '', array &$tags = [], &$expire = null )
	{
		...
		/** client/html/email/account/text/standard/template-body
		 ...
		 * @since 2015.09
		 * @category Developer
		 * @see client/html/email/account/text/standard/template-header
		 */
