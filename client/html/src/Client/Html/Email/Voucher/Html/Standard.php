...
{
	/** client/html/email/voucher/html/standard/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/email/voucher/html/standard/subparts';
	...
	public function getBody( $uid = '' )
	{
		...
		/** client/html/email/voucher/html/standard/template-body
		 ...
		 * @since 2018.07
		 * @category Developer
		 * @see client/html/email/voucher/html/standard/template-header
		 */
		$tplconf = 'client/html/email/voucher/html/standard/template-body';

		$html = $view->render( $view->config( $tplconf, 'email/voucher/html-body-standard.php' ) );
