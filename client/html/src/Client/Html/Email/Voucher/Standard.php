...
/**
 * Default implementation of the voucher e-mails
 *
 * @package Client
 * @subpackage Html
 */
...
{
	/** client/html/email/voucher/standard/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/email/voucher/standard/subparts';

	/** client/html/email/voucher/text/name
	...
	public function getBody( $uid = '' )
	{
		 ...
		 * @since 2018.07
		 * @category Developer
		 * @see client/html/email/voucher/standard/template-header
		 */
		$tplconf = 'client/html/email/voucher/standard/template-body';

		return $view->render( $view->config( $tplconf, 'email/voucher/body-standard.php' ) );
	}
	...
	public function getHeader( $uid = '' )
	{
		 ...
		 * @since 2018.07
		 * @category Developer
		 * @see client/html/email/voucher/standard/template-body
		 */
		$tplconf = 'client/html/email/voucher/standard/template-header';

		return $view->render( $view->config( $tplconf, 'email/voucher/header-standard.php' ) ); ;
	}
	...
	public function getSubClient( $type, $name = null )
	{
		...
		return $this->createSubClient( 'email/voucher/' . $type, $name );
	}
