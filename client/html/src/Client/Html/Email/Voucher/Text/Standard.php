...
/**
 * Default implementation of voucher email text HTML client.
 *
 * @package Client
 * @subpackage Html
 */
...
{
	/** client/html/email/voucher/text/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/email/voucher/text/subparts';
	...
	public function body( string $uid = '' ) : string
	{
		...
		/** client/html/email/voucher/text/template-body
		 ...
		 * @since 2018.07
		 * @category Developer
		 * @see client/html/email/voucher/text/template-header
		 */
		$tplconf = 'client/html/email/voucher/text/template-body';

		$text = $view->render( $view->config( $tplconf, 'email/voucher/text-body' ) );
		$view->mail()->text( $text );
		return $text;
	}
	...
	public function getSubClient( string $type, string $name = null ) : \Aimeos\Client\Html\Iface
	{
		 ...
		 * @see client/html/email/voucher/text/decorators/global
		 * @see client/html/email/voucher/text/decorators/local
		 */
		 ...
		 * @category Developer
		 * @see client/html/common/decorators/default
		 * @see client/html/email/voucher/text/decorators/excludes
		 * @see client/html/email/voucher/text/decorators/local
		 */
		...
		return $this->createSubClient( 'email/voucher/text/' . $type, $name );
	}
