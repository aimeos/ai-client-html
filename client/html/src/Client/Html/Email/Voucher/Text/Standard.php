...
{
	/** client/html/email/voucher/text/standard/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/email/voucher/text/standard/subparts';
	...
	public function getBody( $uid = '' )
	{
		...
		/** client/html/email/voucher/text/standard/template-body
		 ...
		 * @since 2018.07
		 * @category Developer
		 * @see client/html/email/voucher/text/standard/template-header
		 */
