...
{
	/** client/html/email/delivery/text/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/email/delivery/text/subparts';
	...
	public function body( string $uid = '' ) : string
	{
		...
		/** client/html/email/delivery/text/template-body
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/email/delivery/text/template-header
		 */
		$tplconf = 'client/html/email/delivery/text/template-body';

		$text = $view->render( $view->config( $tplconf, 'email/delivery/text-body' ) );
		$view->mail()->text( $text );
