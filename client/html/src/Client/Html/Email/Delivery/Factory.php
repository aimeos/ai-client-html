	...
	implements \Aimeos\Client\Html\Common\Factory\Iface
{
	 ...
	 * @return \Aimeos\Client\Html\Iface Delivery part implementing \Aimeos\Client\Html\Iface
	...
	public static function create( \Aimeos\MShop\Context\Item\Iface $context, string $name = null ) : \Aimeos\Client\Html\Iface
	{
		 ...
		 */
		if( $name === null ) {
			$name = $context->config()->get( 'client/html/email/delivery/name', 'Standard' );
		}
		...
		$client = self::addClientDecorators( $context, $client, 'email/delivery' );
