...
/**
 * Default implementation of product notification email text HTML client.
 *
 * @package Client
 * @subpackage Html
 */
...
{
	/** client/html/email/watch/text/standard/subparts
	...
	public function getBody( string $uid = '' ) : string
	{
		...
		/** client/html/email/watch/text/standard/template-body
		 ...
		 * @since 2014.09
		 * @category Developer
		 * @see client/html/email/watch/text/standard/template-header
		 */
		$tplconf = 'client/html/email/watch/text/standard/template-body';

		$text = $view->render( $view->config( $tplconf, 'email/watch/text-body-standard' ) );
