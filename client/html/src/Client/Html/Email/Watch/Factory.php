	...
	implements \Aimeos\Client\Html\Common\Factory\Iface
{
	 ...
	 * @return \Aimeos\Client\Html\Iface Watch part implementing \Aimeos\Client\Html\Iface
	...
	public static function create( \Aimeos\MShop\Context\Item\Iface $context, string $name = null ) : \Aimeos\Client\Html\Iface
	{
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'client/html/email/watch/name', 'Standard' );
		}
		...
		$client = self::addClientDecorators( $context, $client, 'email/watch' );
