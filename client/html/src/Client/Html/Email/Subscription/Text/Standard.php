...
/**
 * Default implementation of subscription email text HTML client.
 *
 * @package Client
 * @subpackage Html
 */
...
{
	/** client/html/email/subscription/text/standard/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/email/subscription/text/standard/subparts';
	...
	public function getBody( $uid = '' )
	{
		...
		/** client/html/email/subscription/text/standard/template-body
		 ...
		 * @since 2018.04
		 * @category Developer
		 * @see client/html/email/subscription/text/standard/template-header
		 */
		$tplconf = 'client/html/email/subscription/text/standard/template-body';

		$text = $view->render( $view->config( $tplconf, 'email/subscription/text-body-standard.php' ) );
	...
	public function getSubClient( $type, $name = null )
	{
		 ...
		 * @see client/html/email/subscription/text/decorators/global
		 * @see client/html/email/subscription/text/decorators/local
		 */
		 ...
		 * @category Developer
		 * @see client/html/common/decorators/default
		 * @see client/html/email/subscription/text/decorators/excludes
		 * @see client/html/email/subscription/text/decorators/local
		 */
		...
		return $this->createSubClient( 'email/subscription/text/' . $type, $name );
	}
