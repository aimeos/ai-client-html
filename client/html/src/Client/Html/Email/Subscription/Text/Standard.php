...
{
	/** client/html/email/subscription/text/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/email/subscription/text/subparts';
	...
	public function body( string $uid = '' ) : string
	{
		...
		/** client/html/email/subscription/text/template-body
		 ...
		 * @since 2018.04
		 * @category Developer
		 * @see client/html/email/subscription/text/template-header
		 */
		$tplconf = 'client/html/email/subscription/text/template-body';

		$text = $view->render( $view->config( $tplconf, 'email/subscription/text-body' ) );
		$view->mail()->text( $text );
