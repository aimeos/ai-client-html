...
/**
 * Factory for subscription end email HTML clients.
 *
 * @package Client
 * @subpackage Html
 */
...
{
	/**
	 * Creates an subscription creation email client object.
	 *
	 * @param \Aimeos\MShop\Context\Item\Iface $context Shop context instance with necessary objects
	 * @param string|null $name Client name (default: "Standard")
	 * @return \Aimeos\Client\Html\Iface Subscription part implementing \Aimeos\Client\Html\Iface
	...
	{
		/** client/html/email/subscription/name
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'client/html/email/subscription/name', 'Standard' );
		}

		$iface = '\\Aimeos\\Client\\Html\\Iface';
		$classname = '\\Aimeos\\Client\\Html\\Email\\Subscription\\' . $name;
		...
		$client = self::addClientDecorators( $context, $client, 'email/subscription' );
