...
{
	/** client/html/email/subscription/html/standard/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/email/subscription/html/standard/subparts';
	...
	public function getBody( $uid = '' )
	{
		...
		/** client/html/email/subscription/html/standard/template-body
		 ...
		 * @since 2018.04
		 * @category Developer
		 * @see client/html/email/subscription/html/standard/template-header
		 */
		$tplconf = 'client/html/email/subscription/html/standard/template-body';

		$html = $view->render( $view->config( $tplconf, 'email/subscription/html-body-standard.php' ) );
