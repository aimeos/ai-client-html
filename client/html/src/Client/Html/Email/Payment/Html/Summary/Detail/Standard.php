...
/**
 * Default implementation of HTML payment e-mail summary detail HTML client.
 *
 * @package Client
 * @subpackage Html
 */
...
{
	/** client/html/email/payment/html/summary/detail/standard/subparts
	 * List of HTML sub-clients rendered within the summary detail section of the payment HTML e-mail
	 *
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/email/payment/html/summary/detail/standard/subparts';
	...
	*/
	public function getBody( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/email/payment/html/summary/detail/standard/template-body
		 * Relative path to the HTML body template of the summary detail section of the payment HTML e-mail client.
		 *
		 ...
		 * @since 2015.11
		 * @category Developer
		 * @see client/html/email/payment/html/summary/detail/standard/template-header
		 */
		$tplconf = 'client/html/email/payment/html/summary/detail/standard/template-body';
