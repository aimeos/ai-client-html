...
{
	/** client/html/email/payment/text/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/email/payment/text/subparts';
	...
	public function body( string $uid = '' ) : string
	{
		...
		/** client/html/email/payment/text/template-body
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/email/payment/text/template-header
		 */
		$tplconf = 'client/html/email/payment/text/template-body';

		$text = $view->render( $view->config( $tplconf, 'email/payment/text-body' ) );
		$view->mail()->text( $text );
