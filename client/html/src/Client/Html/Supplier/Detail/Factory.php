...
/**
 * Factory for detail part in supplier for HTML clients.
 *
 * @package Client
 * @subpackage Html
 */
...
{
	/**
	 * Creates a detail client object.
	 *
	 * @param \Aimeos\MShop\Context\Item\Iface $context Shop context instance with necessary objects
	 * @param string|null $name Client name (default: "Standard")
	 * @return \Aimeos\Client\Html\Iface Detail part implementing \Aimeos\Client\Html\Iface
	...
	public static function create( \Aimeos\MShop\Context\Item\Iface $context, string $name = null ) : \Aimeos\Client\Html\Iface
	{
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'client/html/supplier/detail/name', 'Standard' );
		}

		$iface = '\\Aimeos\\Client\\Html\\Iface';
		$classname = '\\Aimeos\\Client\\Html\\Supplier\\Detail\\' . $name;
		...
		$client = self::addClientDecorators( $context, $client, 'supplier/detail' );
