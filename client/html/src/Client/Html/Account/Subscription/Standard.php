...
{
	/** client/html/account/subscription/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/account/subscription/subparts';
	...
	public function body( string $uid = '' ) : string
	{
		 ...
		 */
		$tplconf = 'client/html/account/subscription/template-body';
	...
	public function header( string $uid = '' ) : ?string
	{
		...
		try
		{
			 ...
			 */
			$tplconf = 'client/html/account/subscription/template-header';
