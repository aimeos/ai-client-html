...
{
	/** client/html/account/history/detail/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/account/history/detail/subparts';
	...
	public function body( string $uid = '' ) : string
	{
		...
		/** client/html/account/history/detail/template-body
		 ...
		 * @since 2015.02
		 * @category Developer
		 * @see client/html/account/history/detail/template-header
		 */
		$tplconf = 'client/html/account/history/detail/template-body';
		$default = 'account/history/detail-body-standard';
	...
	{
		/** client/html/account/history/detail/decorators/excludes
		 * Excludes decorators added by the "common" option from the account history detail html client
		 *
		 ...
		 *
		 *  client/html/account/history/detail/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see client/html/account/history/detail/decorators/global
		 * @see client/html/account/history/detail/decorators/local
		 */

		/** client/html/account/history/detail/decorators/global
		 * Adds a list of globally available decorators only to the account history detail html client
		 *
		 * Decorators extend the functionality of a class by adding new aspects
		 * (e.g. log what is currently done), executing the methods of the underlying
		 * class only in certain conditions (e.g. only for logged in users) or
		 ...
		 *
		 *  client/html/account/history/detail/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see client/html/common/decorators/default
		 * @see client/html/account/history/detail/decorators/excludes
		 * @see client/html/account/history/detail/decorators/local
		 */

		/** client/html/account/history/detail/decorators/local
		 * Adds a list of local decorators only to the account history detail html client
		 *
		 * Decorators extend the functionality of a class by adding new aspects
		 * (e.g. log what is currently done), executing the methods of the underlying
		 * class only in certain conditions (e.g. only for logged in users) or
		 ...
		 *
		 *  client/html/account/history/detail/decorators/local = array( 'decorator2' )
		 *
		...
		return $this->createSubClient( 'account/history/detail/' . $type, $name );
	}
