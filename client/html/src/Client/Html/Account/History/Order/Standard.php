...
{
	/** client/html/account/history/order/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/account/history/order/subparts';
	...
	public function body( string $uid = '' ) : string
	{
		...
		/** client/html/account/history/order/template-body
		 ...
		 * @since 2015.02
		 * @category Developer
		 * @see client/html/account/history/order/template-header
		 */
		$tplconf = 'client/html/account/history/order/template-body';
