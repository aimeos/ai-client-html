...
$addBasket = $this->config( 'client/html/catalog/lists/basket-add', false );
	...
	<ul class="list-items list"><!--
		...
		<?php foreach( $this->get( 'listProductItems', array() ) as $id => $productItem ) : $firstImage = true; ?>
			<?php
				...
				$url = $enc->attr( $this->url( $detailTarget, $detailController, $detailAction, $params, array(), $detailConfig ) );
