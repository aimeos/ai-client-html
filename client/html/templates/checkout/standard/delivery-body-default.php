		...
		<div id="c_delivery-<?php echo $enc->attr( $id ); ?>" class="item item-service">
			<label class="description" for="c_deliveryoption-<?php echo $enc->attr( $id ); ?>">
				...
				<input class="option" type="radio"
					id="c_deliveryoption-<?php echo $enc->attr( $id ); ?>"
					name="<?php echo $enc->attr( $this->formparam( array( 'c_deliveryoption' ) ) ); ?>"
						...
						<li class="form-item <?php echo $enc->attr( $key ) . $css; ?>">
							...
							--><?php switch( $attribute->getType() ) : case 'select': ?><!--
								...
								--><?php break; case 'boolean': ?><!--
									--><input type="checkbox" id="delivery-<?php echo $enc->attr( $key ); ?>"
										name="<?php echo $enc->attr( $this->formparam( array( 'c_delivery', $id, $key ) ) ); ?>"
										value="<?php echo $enc->attr( $this->param( 'c_delivery/' . $id . '/' . $key, $value ) ); ?>"
									/><!--

								--><?php break; case 'integer': case 'number': ?><!--
									--><input type="number" id="delivery-<?php echo $enc->attr( $key ); ?>"
										name="<?php echo $enc->attr( $this->formparam( array( 'c_delivery', $id, $key ) ) ); ?>"
										value="<?php echo $enc->attr( $this->param( 'c_delivery/' . $id . '/' . $key, $value ) ); ?>"
									/><!--

								--><?php break; case 'date': case 'datetime': case 'time': ?><!--
									--><input type="<?php echo $attribute->getType(); ?>" id="delivery-<?php echo $enc->attr( $key ); ?>"
										name="<?php echo $enc->attr( $this->formparam( array( 'c_delivery', $id, $key ) ) ); ?>"
										value="<?php echo $enc->attr( $this->param( 'c_delivery/' . $id . '/' . $key, $value ) ); ?>"
									/><!--

								--><?php break; default: ?><!--
									--><input type="text" id="delivery-<?php echo $enc->attr( $key ); ?>"
										name="<?php echo $enc->attr( $this->formparam( array( 'c_delivery', $id, $key ) ) ); ?>"
										value="<?php echo $enc->attr( $this->param( 'c_delivery/' . $id . '/' . $key, $value ) ); ?>"
									/><!--
							--><?php endswitch; ?>
