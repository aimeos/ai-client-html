...
?>
<li class="form-item salutation <?= ( isset( $css['order.base.address.salutation'] ) ? join( ' ', $css['order.base.address.salutation'] ) : '' ); ?>">

	<label for="address-<?= $type ?>-salutation<?= $idstr ?>">
		<?= $enc->html( $this->translate( 'client', 'Salutation' ), $enc::TRUST ); ?>
	</label><!--

	--><select id="address-<?= $type ?>-salutation<?= $idstr ?>"
...
<li class="form-item firstname <?= ( isset( $css['order.base.address.firstname'] ) ? join( ' ', $css['order.base.address.firstname'] ) : '' ); ?>"
	data-regex="<?= $testfcn( $regex, 'order.base.address.firstname' ); ?>" >

	<label for="address-<?= $type ?>-firstname<?= $idstr ?>">
...
<li class="form-item lastname <?= ( isset( $css['order.base.address.lastname'] ) ? join( ' ', $css['order.base.address.lastname'] ) : '' ); ?>"
	data-regex="<?= $testfcn( $regex, 'order.base.address.lastname' ); ?>">

	<label for="address-<?= $type ?>-lastname<?= $idstr ?>">
...
<li class="form-item company <?= ( isset( $css['order.base.address.company'] ) ? join( ' ', $css['order.base.address.company'] ) : '' ); ?>"
	data-regex="<?= $testfcn( $regex, 'order.base.address.company' ); ?>">

	<label for="address-<?= $type ?>-company<?= $idstr ?>">
...
<li class="form-item address1 <?= ( isset( $css['order.base.address.address1'] ) ? join( ' ', $css['order.base.address.address1'] ) : '' ); ?>"
	data-regex="<?= $testfcn( $regex, 'order.base.address.address1' ); ?>">

	<label for="address-<?= $type ?>-address1<?= $idstr ?>">
...
<li class="form-item address2 <?= ( isset( $css['order.base.address.address2'] ) ? join( ' ', $css['order.base.address.address2'] ) : '' ); ?>"
	data-regex="<?= $testfcn( $regex, 'order.base.address.address2' ); ?>">

	<label for="address-<?= $type ?>-address2<?= $idstr ?>">
...
<li class="form-item address3 <?= ( isset( $css['order.base.address.address3'] ) ? join( ' ', $css['order.base.address.address3'] ) : '' ); ?>"
	data-regex="<?= $testfcn( $regex, 'order.base.address.address3' ); ?>">

	<label for="address-<?= $type ?>-address3<?= $idstr ?>">
...
<li class="form-item city <?= ( isset( $css['order.base.address.city'] ) ? join( ' ', $css['order.base.address.city'] ) : '' ); ?>"
	data-regex="<?= $testfcn( $regex, 'order.base.address.city' ); ?>">

	<label for="address-<?= $type ?>-city<?= $idstr ?>">
...
<?php if( count( $states ) > 0 ) : ?>
	<li class="form-item state <?= ( isset( $css['order.base.address.state'] ) ? join( ' ', $css['order.base.address.state'] ) : '' ); ?>">

		<label for="address-<?= $type ?>-state<?= $idstr ?>">
			<?= $enc->html( $this->translate( 'client', 'State' ), $enc::TRUST ); ?>
		</label><!--

		--><select id="address-<?= $type ?>-state<?= $idstr ?>"
...
<li class="form-item postal <?= ( isset( $css['order.base.address.postal'] ) ? join( ' ', $css['order.base.address.postal'] ) : '' ); ?>"
	data-regex="<?= $testfcn( $regex, 'order.base.address.postal' ); ?>">

	<label for="address-<?= $type ?>-postal<?= $idstr ?>">
...
<?php if( count( $countries ) > 0 ) : ?>
	<li class="form-item countryid <?= ( isset( $css['order.base.address.countryid'] ) ? join( ' ', $css['order.base.address.countryid'] ) : '' ); ?>">

		<label for="address-<?= $type ?>-countryid<?= $idstr ?>">
			<?= $enc->html( $this->translate( 'client', 'Country' ), $enc::TRUST ); ?>
		</label><!--

		--><select id="address-<?= $type ?>-countryid<?= $idstr ?>"
...
<li class="form-item languageid <?= ( isset( $css['order.base.address.languageid'] ) ? join( ' ', $css['order.base.address.languageid'] ) : '' ); ?>"
	<?= $disablefcn( $css, 'order.base.address.languageid' ); ?> >

	<label for="address-<?= $type ?>-languageid<?= $idstr ?>">
		<?= $enc->html( $this->translate( 'client', 'Language' ), $enc::TRUST ); ?>
	</label><!--

	--><select id="address-<?= $type ?>-languageid<?= $idstr ?>"
...
<li class="form-item vatid <?= ( isset( $css['order.base.address.vatid'] ) ? join( ' ', $css['order.base.address.vatid'] ) : '' ); ?>"
	data-regex="<?= $testfcn( $regex, 'order.base.address.vatid' ); ?>">

	<label for="address-<?= $type ?>-vatid<?= $idstr ?>">
...
<li class="form-item email <?= ( isset( $css['order.base.address.email'] ) ? join( ' ', $css['order.base.address.email'] ) : '' ); ?>"
	data-regex="<?= $testfcn( $regex, 'order.base.address.email', '^.+@[a-zA-Z0-9\-]+(\.[a-zA-Z0-9\-]+)*$' ); ?>">

	<label for="address-<?= $type ?>-email<?= $idstr ?>">
...
<li class="form-item telephone <?= ( isset( $css['order.base.address.telephone'] ) ? join( ' ', $css['order.base.address.telephone'] ) : '' ); ?>"
	data-regex="<?= $testfcn( $regex, 'order.base.address.telephone' ); ?>">

	<label for="address-<?= $type ?>-telephone<?= $idstr ?>">
...
<li class="form-item telefax <?= ( isset( $css['order.base.address.telefax'] ) ? join( ' ', $css['order.base.address.telefax'] ) : '' ); ?>"
	data-regex="<?= $testfcn( $regex, 'order.base.address.telefax' ); ?>">

	<label for="address-<?= $type ?>-telefax<?= $idstr ?>">
...
<li class="form-item website <?= ( isset( $css['order.base.address.website'] ) ? join( ' ', $css['order.base.address.website'] ) : '' ); ?>"
	data-regex="<?= $testfcn( $regex, 'order.base.address.website', '^([a-z]+://)?[a-zA-Z0-9\-]+(\.[a-zA-Z0-9\-]+)+(:[0-9]+)?(/.*)?$' ); ?>">

	<label for="address-<?= $type ?>-website<?= $idstr ?>">
