...
$enc = $this->encoder();
$paymentAddress = $deliveryAddress = null;
...
{
	$deliveryAddress = $enc->html( $this->translate( 'client', 'like billing address' ), $enc::TRUST );
}
...
<div class="common-summary-address container">
	...
	<div class="item payment <?php echo ( isset( $errors['address']['payment'] ) ? 'error' : '' ); ?>">
		...
		<div class="header">
			...
			<?php if( isset( $this->summaryUrlAddressBilling ) ) : ?>
				<a class="modify" href="<?php echo $enc->attr( $this->summaryUrlAddressBilling ); ?>">
					<?php echo $enc->html( $this->translate( 'client', 'Change' ), $enc::TRUST ); ?>
				</a>
			<?php endif; ?>
		</div>

		<div class="content"><?php echo $paymentAddress; ?></div>
	...
	--><div class="item delivery <?php echo ( isset( $errors['address']['delivery'] ) ? 'error' : '' ); ?>">
		...
		<div class="content"><?php echo $deliveryAddress; ?></div>
