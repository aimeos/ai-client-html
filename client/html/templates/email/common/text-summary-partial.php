...
<?php			echo strip_tags( sprintf( $taxFormat, $this->number( $taxRate ), $this->translate( 'client/code', $taxName ) ) ) ?>: <?php printf( $this->get( 'priceFormat', '%1$s %2$s' ), $this->number( $taxValue, $priceItem->getPrecision() ), $priceItem->getCurrencyId() ) ?>
