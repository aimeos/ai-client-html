...
'
				...
				?> <?php foreach( $this->summaryBasket->getProducts() as $product ) : ?> <tr class="product"><td class="status"> <?php if( ( $status = $product->getStatus() ) >= 0 ) : $key = 'stat:' . $status ?> <?= $enc->html( $this->translate( 'mshop/code', $key ) ); ?> <?php endif; ?> </td><td class="name"> <?php $params = array_merge( $this->param(), ['d_prodid' => $product->getProductId(), 'd_name' => $product->getName( 'url' )] ); ?> <a class="product-name" href="<?= $enc->attr( $this->url( ( $product->getTarget() ?: $detailTarget ), $detailController, $detailAction, $params, [], $detailConfig ) ); ?>"> <?= $enc->html( $product->getName(), $enc::TRUST ); ?> </a><p class="code"><span class="name"><?= $enc->html( $this->translate( 'client', 'Article no.:' ), $enc::TRUST ); ?></span><span class="value"><?= $product->getProductCode(); ?></span></p> <?php foreach( $this->config( 'client/html/common/summary/detail/product/attribute/types', ['variant', 'config', 'custom'] ) as $attrType ) : ?> <ul class="attr-list attr-type-<?= $enc->attr( $attrType ); ?>"> <?php foreach( $product->getAttributeItems( $attrType ) as $attribute ) : ?> <li class="attr-item attr-code-<?= $enc->attr( $attribute->getCode() ); ?>"><span class="name"><?= $enc->html( $this->translate( 'client/code', $attribute->getCode() ) ); ?></span><span class="value"> <?php if( $attribute->getQuantity() > 1 ) : ?> <?= $enc->html( $attribute->getQuantity() ); ?>× <?php endif; ?> <?= $enc->html( ( $attribute->getName() != '' ? $attribute->getName() : $attribute->getValue() ) ); ?> </span></li> <?php endforeach; ?> </ul> <?php endforeach; ?> <?php if( $this->extOrderItem->getPaymentStatus() >= $this->config( 'client/html/common/summary/detail/download/payment-status', \Aimeos\MShop\Order\Item\Base::PAY_RECEIVED )
							...
							] ); ?> </td></tr> <?php endforeach; ?> <?php foreach( $this->summaryBasket->getService( 'delivery' ) as $service ) : ?> <?php if( $service->getPrice()->getValue() > 0 ) : $priceItem = $service->getPrice(); ?> <tr class="delivery"><td class="name"><?= $enc->html( $service->getName() ); ?></td><td class="quantity">1</td><td class="price"><?= $enc->html( sprintf( $priceFormat, $this->number( $priceItem->getValue(), $priceItem->getPrecision() ), $priceItem->getCurrencyId() ) ); ?></td></tr> <?php endif; ?> <?php endforeach; ?> <?php foreach( $this->summaryBasket->getService( 'payment' ) as $service ) : ?> <?php if( $service->getPrice()->getValue() > 0 ) : $priceItem = $service->getPrice(); ?> <tr class="payment"><td class="name"><?= $enc->html( $service->getName() ); ?></td><td class="quantity">1</td><td class="price"><?= $enc->html( sprintf( $priceFormat, $this->number( $priceItem->getValue(), $priceItem->getPrecision() ), $priceItem->getCurrencyId() ) ); ?></td></tr> <?php endif; ?> <?php endforeach; ?> </tbody></table></td></tr></table></div></td></tr></tbody><tfoot> <?php if( $this->summaryBasket->getPrice()->getCosts() > 0 ) : ?> <tr class="subtotal"><td colspan="3"><?= $enc->html( $this->translate( 'client', 'Sub-total' ) ); ?></td><td class="price"><?= $enc->html( sprintf( $priceFormat, $this->number( $this->summaryBasket->getPrice()->getValue(), $this->summaryBasket->getPrice()->getPrecision() ), $this->summaryBasket->getPrice()->getCurrencyId() ) ); ?></td></tr> <?php endif; ?> <?php if( ( $costs = $this->get( 'standardCostsDelivery', 0 ) ) > 0 ) : ?> <tr class="delivery"><td colspan="3"><?= $enc->html( $this->translate( 'client', 'Shipping' ) ); ?></td><td class="price"><?= $enc->html( sprintf( $priceFormat, $this->number( $costs, $this->summaryBasket->getPrice()->getPrecision() ), $this->summaryBasket->getPrice()->getCurrencyId() ) ); ?></td></tr> <?php endif; ?> <?php if( ( $costs = $this->get( 'standardCostsPayment', 0 ) ) > 0 ) : ?> <tr class="delivery"><td colspan="3"><?= $enc->html( $this->translate( 'client', 'Payment costs' ) ); ?></td><td class="price"><?= $enc->html( sprintf( $priceFormat, $this->number( $costs, $this->summaryBasket->getPrice()->getPrecision() ), $this->summaryBasket->getPrice()->getCurrencyId() ) ); ?></td></tr> <?php endif; ?> <?php if( $this->summaryBasket->getPrice()->getTaxFlag() === true ) : ?> <tr class="total"><td colspan="3"><?= $enc->html( $this->translate( 'client', 'Total' ) ); ?></td><td class="price"><?= $enc->html( sprintf( $priceFormat, $this->number( $this->summaryBasket->getPrice()->getValue() + $this->summaryBasket->getPrice()->getCosts(), $this->summaryBasket->getPrice()->getPrecision() ), $this->summaryBasket->getPrice()->getCurrencyId() ) ); ?></td></tr> <?php endif; ?> <?php foreach( $this->get( 'summaryTaxRates', [] ) as $taxRate => $priceItem ) : ?> <?php if( ( $taxValue = $priceItem->getTaxValue() ) > 0 ) : ?> <tr class="tax"><td colspan="3"><?= $enc->html( sprintf( $priceItem->getTaxFlag() ? $this->translate( 'client', 'Incl. %1$s%% VAT' ) : $this->translate( 'client', '+ %1$s%% VAT' ), $this->number( $taxRate ) ) ); ?></td><td class="price"><?= $enc->html( sprintf( $priceFormat, $this->number( $taxValue, $priceItem->getPrecision() ), $priceItem->getCurrencyId() ) ); ?></td></tr> <?php endif; ?> <?php endforeach; ?> <?php if( $this->summaryBasket->getPrice()->getTaxFlag() === false ) : ?> <tr class="total"><td colspan="3"><?= $enc->html( $this->translate( 'client', 'Total' ) ); ?></td><td class="price"><?= $enc->html( sprintf( $priceFormat, $this->number( $this->summaryBasket->getPrice()->getValue() + $this->summaryBasket->getPrice()->getCosts() + $this->summaryBasket->getPrice()->getTaxValue(), $this->summaryBasket->getPrice()->getPrecision() ), $this->summaryBasket->getPrice()->getCurrencyId() ) ); ?></td></tr> <?php endif; ?> <?php if( $this->summaryBasket->getPrice()->getRebate() > 0 ) : ?> <tr class="rebate"><td colspan="3"><?= $enc->html( $this->translate( 'client', 'Included rebates' ) ); ?></td><td class="price"><?= $enc->html( sprintf( $priceFormat, $this->number( $this->summaryBasket->getPrice()->getValue(), $this->summaryBasket->getPrice()->getPrecision() ), $this->summaryBasket->getPrice()->getCurrencyId() ) ); ?></td></tr> <?php endif; ?> </tfoot></table></div><!--[if mso | IE]></td></tr></table><![endif]--></div><!--[if mso | IE]></td></tr></table><table align="center" border="0" cellpadding="0" cellspacing="0" class="email-common-outro-outlook" style="width:600px;" width="600" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]--><div class="email-common-outro" style="Margin:0px auto;max-width:600px;"><table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;"><tbody><tr><td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;vertical-align:top;"><!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" style="vertical-align:top;width:600px;" ><![endif]--><div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;"><table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%"><tr><td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;"><div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;"> <?= $enc->html( nl2br( $this->translate( 'client', 'If you have any questions, please reply to this e-mail' ) ), $enc::TRUST ); ?> </div></td></tr></table></div><!--[if mso | IE]></td></tr></table><![endif]--></td></tr></tbody></table></div><!--[if mso | IE]></td></tr></table><table align="center" border="0" cellpadding="0" cellspacing="0" class="email-common-legal-outlook" style="width:600px;" width="600" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]--><div class="email-common-legal" style="Margin:0px auto;max-width:600px;"><table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;"><tbody><tr><td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;vertical-align:top;"><!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" style="vertical-align:top;width:600px;" ><![endif]--><div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;"><table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%"><tr><td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;"><div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;"> <?= nl2br( $enc->html( $this->translate( 'client', 'All orders are subject to our terms and conditions.' ), $enc::TRUST ) ); ?> </div></td></tr></table></div><!--[if mso | IE]></td></tr></table><![endif]--></td></tr></tbody></table></div><!--[if mso | IE]></td></tr></table><![endif]--></body></html>
<?php $this->block()->stop(); ?>
